...
const he = {
  ...
  "squad.navLink": "טקטיקה וסגל",
  "squad.title": "טקטיקה וסגל",
  "squad.formation": "מערך",
  "squad.tacticStyle": "סגנון משחק",
  "squad.tacticDefensive": "הגנתי",
  "squad.tacticBalanced": "מאוזן",
  "squad.tacticAttacking": "התקפי",
  "squad.startingXI": "הרכב פותח",
  "squad.bench": "ספסל",
  "squad.dragHint": "גררו שחקנים על המגרש כדי לשנות את מיקומם. לחצו על שחקן בספסל ואז על שחקן במגרש כדי להחליף ביניהם.",
  "squad.save": "שמירת הרכב",
  "squad.saved": "ההרכב נשמר",
  "squad.position.GK": "שוער",
  "squad.position.DF": "בלם",
  "squad.position.MF": "קשר",
  "squad.position.FW": "חלוץ",
...
const en: Record<keyof typeof he, string> = {
  ...
  "squad.navLink": "Tactics & Squad",
  "squad.title": "Tactics & Squad",
  "squad.formation": "Formation",
  "squad.tacticStyle": "Playing style",
  "squad.tacticDefensive": "Defensive",
  "squad.tacticBalanced": "Balanced",
  "squad.tacticAttacking": "Attacking",
  "squad.startingXI": "Starting XI",
  "squad.bench": "Bench",
  "squad.dragHint": "Drag players on the pitch to reposition them. Click a bench player then a pitch player to swap them.",
  "squad.save": "Save lineup",
  "squad.saved": "Lineup saved",
  "squad.position.GK": "GK",
  "squad.position.DF": "DF",
  "squad.position.MF": "MF",
  "squad.position.FW": "FW",
...
const ar: Record<keyof typeof he, string> = {
  ...
  "squad.navLink": "التكتيك والتشكيلة",
  "squad.title": "التكتيك والتشكيلة",
  "squad.formation": "التشكيل",
  "squad.tacticStyle": "أسلوب اللعب",
  "squad.tacticDefensive": "دفاعي",
  "squad.tacticBalanced": "متوازن",
  "squad.tacticAttacking": "هجومي",
  "squad.startingXI": "التشكيلة الأساسية",
  "squad.bench": "دكة البدلاء",
  "squad.dragHint": "اسحب اللاعبين على الملعب لتغيير مواقعهم. اضغط على لاعب من دكة البدلاء ثم على لاعب في الملعب لتبديلهما.",
  "squad.save": "حفظ التشكيلة",
  "squad.saved": "تم حفظ التشكيلة",
  "squad.position.GK": "حارس",
  "squad.position.DF": "مدافع",
  "squad.position.MF": "وسط",
  "squad.position.FW": "مهاجم",
