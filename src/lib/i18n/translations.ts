...
const he = {
  ...
  "team.city": "עיר",
  "team.cityPlaceholder": "חפשו עיר",
  "team.cityNeedsCountry": "בחרו מדינה קודם",
  "team.cityNoResults": "לא נמצאו ערים",
  ...
  "validation.cityRequired": "יש לבחור עיר",
...
const en: Record<keyof typeof he, string> = {
  ...
  "team.city": "City",
  "team.cityPlaceholder": "Search for a city",
  "team.cityNeedsCountry": "Select a country first",
  "team.cityNoResults": "No cities found",
...
const ar: Record<keyof typeof he, string> = {
  ...
  "team.city": "المدينة",
  "team.cityPlaceholder": "ابحث عن مدينة",
  "team.cityNeedsCountry": "اختر دولة أولاً",
  "team.cityNoResults": "لم يتم العثور على مدن",
  ...
  "validation.cityRequired": "يجب اختيار مدينة",
